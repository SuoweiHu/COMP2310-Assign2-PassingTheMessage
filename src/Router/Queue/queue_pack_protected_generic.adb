...
-- No exceptions required, since there are entry guards. They simply wait until the entry is ok to enter
-- Procedures are mutex, entries are sequential w/ guards, functions are concurrent w/out side effects
